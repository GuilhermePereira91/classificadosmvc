                    ...
                    <form method="GET">
                        ...
                        <label for="categoria">Categoria:</label>
                            ...
                            <select id="preco" name="filtros[preco]" class="form-control">
                                ...
                                <option value="500-1000" <?php echo ($filtros['preco']=='500-1000')?'selected="selected"':''; ?>>R$ 500 - 1000</option>
                            </select>
                ...
                <div class="col-9">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <img src="<?php echo BASE_URL; ?>assets/images/anuncios/<?php echo $anuncio['url']; ?>"height="100" width="150" border=0 />
                                <?php else: ?>
                                <img src="<?php echo BASE_URL; ?>assets/images/default-foto.png" height="100" width="150" border=0 />
                                <?php endif; ?>
                            </td>
                            <td>
                    ...
                    <ul class="pagination">
                        <?php for($q=1;$q<=$total_paginas;$q++): ?>
                            <li class="<?php echo ($pg=$q)?'page-item':'';?>"><a class="page-link" href="<?php echo BASE_URL; ?>?<?php $w = $_GET; $w['p'] = $q; echo http_build_query($w); ?>"><?php echo $q; ?></a></li>
                        <?php endfor;?>
                    </ul>
                </div>
            </div>
