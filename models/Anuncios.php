...
class Anuncios extends model{
    ...
    public function addAnuncio($titulo, $categorias, $valor, $descricao, $estado){
        ...
        $sql->bindValue(":id_categoria", $categorias);
        $sql->execute();
    }
    public function excluirAnuncio($id){
        
        $sql = $this->db->prepare("DELETE FROM anuncios_imagens WHERE id_anuncio = :id");
        $sql->bindValue(":id", $id);
        $sql->execute();
    ...
    public function editaAnuncio($id,$titulo,$categorias,$valor,$descricao,$estado, $fotos){
            ...
            for($q=0;$q<count($fotos['tmp_name']);$q++){
                ...
                if(in_array($tipo,array('image/jpeg', 'image/png'))){
                    ...
                    if($tipo = 'image/jpeg'){
                        ...
                        imagecopyresampled($img,$orig,0,0,0,0,$width,$height,$width_orig,$height_orig);
                        imagepng($img,'assets/images/anuncios/'.$tmpname,80);
                    }           
